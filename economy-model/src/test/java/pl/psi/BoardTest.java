...
public class BoardTest {
    ...
    void shouldBarierWorksProperly() {
        final EconomyHero economyHero = new EconomyHero(HeroStatistics.builder().moveRange(3).build());
    ...
    void shouldLearningStoneWorksProperly() {
        ...
        final EconomyHero economyHero = new EconomyHero(HeroStatistics.builder().moveRange(3).experience(0).build());
        final EconomyHero economyHero2 = new EconomyHero(HeroStatistics.builder().moveRange(3).experience(50).build());
