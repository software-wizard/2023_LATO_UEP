...
public enum CreatureStatistic implements CreatureStatisticIf
{
    ...
    WALKING_DEAD("Walking Dead", 5, 5, 15, 3, Range.closed(2, 3), 2,
            "Basically its the same skeleton with more hit points. I prefer buying 2 skeletons instead.", false, new BehaviourDeterminatorIf() {
        @Override
        public boolean canAttack() {
            return true;
        }
    ...
    SKELETON_WARRIOR("Skeleton Warrior", 6, 6, 6, 5, Range.closed(1, 3), 1,
            ...
            true, new BehaviourDeterminatorIf() {
        @Override
        public boolean canAttack() {
            return true;
        }
